...
import gesture  # Import the gesture module
import queue
...
class RegionProcessor:
    def __init__(self, json_file="regions.json"):
        ...
        self.gesture_processor = gesture.GestureProcessor()
    ...
    def load_from_json(self):
        ...
        try:
            with open(self.json_file, "r") as f:
                data = json.load(f)
                self.regions = list(data.get("regions", {}).values())  # Convert dict values to list
    ...
    def process_regions(self):
        ...
        for i, region in enumerate(self.regions):
            ...
            # Submit both violence and gesture processing tasks
    ...
    def process_region_gesture(self, region, region_id, location):
        ...
        while self.running:
            ...
            frame, gesture_start_time, gesture_count, is_open = self.gesture_processor.process_frame_for_gesture(
